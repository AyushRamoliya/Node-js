...
export default function Milk() {
    ...
    const handleAddProduct = (product) => {
        ...
        dispatch(addBudget({ price: product.price, id: product.id , prolist:product }));
                            ...
                            {record.map((product) => (
                                ...
                                >
                                    ...
                                    <div className="p-4">
                                        ...
                                        <div className="flex items-center justify-around px-4 py-1  text-green-600 text-sm font-medium ">
                                            <p className='text-lg font-bold text-gray-900'>₹{product.price || 'N/A'}</p>

                                            <div className='border-green-600 border rounded bg-[#f5f6fd] text-green-600 ml-5 px-4 py-1'>
                                            {productCounts[product.id] > 0 ? (
                                                <div className="flex items-center ">
                                                    <button  onClick={() => handleRemoveProduct(product)} className=" bg-[#f5f6fd] text-green-600 px-1 py-1" >
                                                        -
                                                    </button>
                                                    <p>{productCounts[product.id]}</p>
                                                    <button onClick={() => handleAddProduct(product)} className=" bg-[#f5f6fd] text-green-600 px-1 py-1">
                                                        +
                                                    </button>
                                                </div>
                                            ) : (
